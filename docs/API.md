...
- **Errors**: validation failures return HTTP 400 (including length constraints); missing channels return HTTP 404; mismatched sender identities return HTTP 403; missing or invalid access tokens return HTTP 401.
