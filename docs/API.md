...
- **Validation**: `name` must be non-empty. Attempting to create a channel for a missing guild returns HTTP 500 in the current prototype; once persistent authz lands it will return a structured client error.
...
{
  "sequence": 1,
  "event_id": "$0d9cc896-d743-43a8-84a7-e79ebf4452b2",
...
```json
{
  ...
  "channel_id": "3b7f3e93-7c9c-47f5-91d3-cbf09dc5a8f6",
  "event": {
    "event_id": "$a8c34cb0-5dc3-4eb2-aadc-e3878a793c6b",
    "event_type": "message",
